...
ylim=(0.0, 1.01)
title = "Gradient Tree Boosting Validation Curve - Learning Rate (cv = 3, stages = 5000)"

param_range = [1, 0.1, 0.05, 0.03, 0.02, 0.01, 0.008, 0.005, 0.001]
print param_range

clf = ensemble.GradientBoostingRegressor(max_features = 0.1, n_estimators = 5000, 
										 max_depth = 6, min_samples_leaf = 1)

import time
start = time.time()
train_scores, test_scores = validation_curve(
    clf, X_shuf, Y_shuf, param_name="learning_rate", param_range=param_range,
