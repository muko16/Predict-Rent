...
ylim=(0.0, 1.01)
title = "Gradient Tree Boosting Validation Curve (cv = 3)"

param_range = [1] + np.linspace(10, 90, 9, dtype = 'int').tolist() \
				  + np.linspace(100, 5000, 50, dtype = 'int').tolist()
print param_range

clf = ensemble.GradientBoostingRegressor(max_features = 0.1, learning_rate = 0.02, 
...
plt.plot(param_range, train_scores_mean, 'o-', color="r", label="score")
