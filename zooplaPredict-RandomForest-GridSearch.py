...
# 1st grid search
#param_dist = {"n_estimators": [2, 4, 8, 10, 16, 24, 48, 96],
#              "max_features": [1.0, 0.5, 0.2, 0.1]}
# 2nd grid search
param_dist = {"n_estimators": [96, 128, 256, 512, 1024, 2048, 4096, 8192],
              "max_features": [0.1, 0.05, 0.01]}

print "\n\n=== Reuslt of Rondom Forest ==="

result = {}	
result["name"] = "Rondom Forest"
