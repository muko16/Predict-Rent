...
ylim=(0.0, 1.01)
title = "SVR Validation Curve (cv = 3)"


#param_range = [0.01, 0.05, 0.1, 0.2, 0.4] 
param_range = np.linspace(1, 6, 6, dtype = 'int').tolist() 
print param_range

clf = svm.SVR(cache_size=1000, kernel='poly', C = 1, gamma = 0.1, epsilon = 0.1)

import time
start = time.time()
train_scores, test_scores = validation_curve(
    clf, X_shuf, Y_shuf, param_name="degree", param_range=param_range,
