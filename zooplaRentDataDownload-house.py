...
param['listing_status'] = "sale" 	# "sale" or "rent"
...
for p in range(1, 3):
	...
	if not os.path.exists(file_path):
		...
		f.writerow(["country","county","displayable_address","first_published_date","last_published_date","latitude","listing_id","listing_status","longitude","num_bathrooms","num_bedrooms","num_floors","num_recepts","outcode","post_town","price","price_change","property_type","status","street_name","walkscore","ws_desc"])
		o.close()
	...
	for x in xrange(0, 100):
		...
		for li in data["listing"]:
			...
			#pd = parser.parse(li["first_published_date"])
			#maxDate = parser.parse("2015-04-10")
